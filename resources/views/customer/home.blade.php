    ...
    <div class="row g-3">
        <div class="col-6 col-md-3 animate-fade-in-up animate-delay-1">
            <div class="feature-badge-card d-flex align-items-center gap-3">
                <div class="feature-icon-wrapper rounded-circle p-2 bg-bakery-cream text-caramel d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-wheat-awn fs-5"></i>
                </div>
                <div>
                    <h6 class="fw-bold text-primary mb-0 feature-title" style="font-size: 0.85rem;">100% Bahan Alami</h6>
        ...
        <div class="col-6 col-md-3 animate-fade-in-up animate-delay-2">
            <div class="feature-badge-card d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="fw-bold text-primary mb-0 feature-title" style="font-size: 0.85rem;">Fresh From Oven</h6>
        ...
        <div class="col-6 col-md-3 animate-fade-in-up animate-delay-3">
            <div class="feature-badge-card d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="fw-bold text-primary mb-0 feature-title" style="font-size: 0.85rem;">Pengiriman Cepat</h6>
                    <span class="text-muted small" style="font-size: 0.72rem;">Sampai Hari Ini</span>
                </div>
            </div>
        </div>

        <div class="col-6 col-md-3 animate-fade-in-up animate-delay-4">
            <div class="feature-badge-card d-flex align-items-center gap-3">
                <div class="feature-icon-wrapper rounded-circle p-2 bg-bakery-cream text-caramel d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-award fs-5"></i>
                </div>
                <div>
                    <h6 class="fw-bold text-primary mb-0 feature-title" style="font-size: 0.85rem;">Kualitas Artisan</h6>
...
<div class="container py-4 mb-5" id="tentang-kami">
    <div class="text-center mb-4 animate-fade-in-up animate-delay-1">
        <span class="badge rounded-pill text-dark fw-semibold py-1.5 px-3 mb-2 badge-pulse" style="background-color: #F3EBDD; color: #593E22 !important; font-size: 0.75rem;">
            <i class="fa-solid fa-cookie-bite me-1 text-caramel"></i> Koleksi Terbaik
        </span>
    ...
    <!-- Category Cards Row (3 Cards with Hover Zoom, Shimmer Beam & Dynamic Content) -->
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4 animate-fade-in-up animate-delay-2">
            <a href="{{ route('shop', ['category' => 'artisan-bread']) }}" class="text-decoration-none d-block">
                <div class="category-card-overlay">
                    <span class="category-glass-tag"><i class="fa-solid fa-star me-1 text-warning"></i> Terfavorit</span>
                    ...
                    <div class="overlay-content">
                        ...
                        <span class="category-link-text">Lihat Pilihan <i class="fa-solid fa-arrow-right ms-1"></i></span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-4 animate-fade-in-up animate-delay-3">
            <a href="{{ route('shop', ['category' => 'french-pastries']) }}" class="text-decoration-none d-block">
                <div class="category-card-overlay">
                    <span class="category-glass-tag"><i class="fa-solid fa-fire me-1 text-caramel"></i> Fresh Baked</span>
        ...
        <!-- Card 3: Kue Premium -->
        <div class="col-md-4 animate-fade-in-up animate-delay-4">
            <a href="{{ route('shop', ['category' => 'premium-cakes']) }}" class="text-decoration-none d-block">
                <div class="category-card-overlay">
                    <span class="category-glass-tag"><i class="fa-solid fa-crown me-1 text-warning"></i> Resep Otentik</span>
